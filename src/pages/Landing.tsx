...
const MILESTONES = [
  { year: 'Evidence', role: 'Resume proof blocks', salary: 'Projects, internships, certificates', skill: 'Source material students can edit' },
  { year: 'Extraction', role: 'Transparent skill parsing', salary: 'Matched phrase + confidence', skill: 'Every skill cites where it came from' },
  { year: 'Readiness', role: '6-dimension profile', salary: 'Score, status, why, source', skill: 'No black-box scoring' },
    ...
    <div className="bg-[#0a0f1e] min-h-screen text-white overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-7 max-w-xl">
              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                ...
                <p className="text-sm text-white/55 leading-relaxed">See what your resume actually proves, where your gaps are, and what to build next before internship season.</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                <div className="text-xs text-cyan-300 font-black uppercase tracking-[0.16em] mb-2">University value</div>
                <p className="text-sm text-white/55 leading-relaxed">Spot cohort-level readiness gaps early and choose interventions faculty and career services can actually run.</p>
              </div>
            </div>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between mb-6">
              <p className="text-xs text-emerald-400 font-black uppercase tracking-widest">Submission module map</p>
            ...
            <p className="mt-5 text-xs text-white/25 italic border-t border-white/10 pt-4">
              Focused on Universities Module 03. Marketplace and employer surfaces remain demo bridges, not new scope.
            </p>
          </Card>
        </div>
      ...
      <div className="border-y border-white/10 bg-white/[0.02] py-5">
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {[
            { num: 'Module 03', label: 'Adaptive Readiness Profile' },
            { num: '5 steps', label: 'evidence to university insight' },
      ...
      <div className="py-14 px-6 bg-[#080d18]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-black text-white">One evidence profile. Two users who need it.</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.08] rounded-2xl overflow-hidden">
            {([
              { step: '01', title: 'Students add proof', desc: 'Resume items become editable evidence blocks with technologies, outcomes, links, and matched phrases.', color: 'text-emerald-400' },
              { step: '02', title: 'PathLens explains readiness', desc: 'Deterministic scoring shows score, status, reason, and evidence source for every dimension.', color: 'text-cyan-400' },
              { step: '03', title: 'Universities intervene', desc: 'Cohort gaps become recommended workshops, reviews, and outreach before graduation.', color: 'text-blue-400' },
            ] as const).map((s) => (
      ...
      <div className="py-12 px-6 bg-[#0a0f1e]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-xs text-white/30 font-black uppercase tracking-widest mb-2">Starter-kit layer</p>
            <h2 className="text-2xl font-black text-white">Career OS bridge, kept lightweight</h2>
            <p className="text-white/38 text-sm mt-2">The interactive module map shows how the readiness profile can feed future candidate, employer, and marketplace surfaces without adding backend scope.</p>
          </div>
      ...
      <div id="role-selection" className="py-20 px-6 bg-[#080d18]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-black text-white mb-4">Who are you here for?</h2>
            <p className="text-white/40 max-w-lg mx-auto">Use the candidate path for the 2-minute demo, or start a blank profile for your own evidence.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <h3 className="text-white font-black text-xl mb-3 leading-tight">
                Talent OS
                <span className="block text-white/40 text-base font-bold mt-1">Evidence-first profile demo</span>
              </h3>
              <p className="text-white/40 text-sm leading-relaxed mb-6">Pick Priya, Kai, or Aisha and inspect profile, evidence, skills, trajectory, and matches.</p>
              <div className="flex flex-wrap gap-2 mb-6">
                {['Evidence pages', 'Readiness audit', 'Gap plan', 'University insight'].map(t => (
              ...
              <div className="flex items-center gap-2 text-emerald-400 font-black text-sm group-hover:gap-3 transition-all duration-200">
                <span>Try the 2-minute demo</span>
                <span>→</span>
              </div>
            </button>
            ...
            >
              <div className="text-xs text-blue-400 font-black uppercase tracking-widest mb-2">For Your Own Evidence</div>
              <h3 className="text-white font-black text-xl mb-3 leading-tight">
                Build Your Profile
                <span className="block text-white/40 text-base font-bold mt-1">Blank evidence intake</span>
              </h3>
              <p className="text-white/40 text-sm leading-relaxed mb-6">Enter your name, university, target role, and evidence items. The profile starts fresh.</p>
              <div className="flex flex-wrap gap-2 mb-6">
                {['No demo profile', 'Editable evidence', 'Skill extraction', 'Readiness score'].map(t => (
          ...
          <p className="text-center text-xs text-white/20 mt-8">
            Talentbank Tech Hackathon 2026 · Stage 1 prototype · No backend integration · No real university data connection
          </p>
        </div>
      </div>
    </div>
