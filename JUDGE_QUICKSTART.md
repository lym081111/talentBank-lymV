...
### Paths Forward (Gaps)
- **Career Marketplace Bridge:** mock internship roles show match score, why the student fits, blockers, and the next evidence to build
...
```bash
npm test
# 95 tests across 9 files - weighted scoring, marketplace matching, market insights, edge cases - all pass
```
